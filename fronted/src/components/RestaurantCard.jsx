...
const RestaurantCard = ({ restaurant }) => {
  return (
    <div className="glass-card" style={{ textAlign: 'left', position: 'relative' }}>
      {/* Título del restaurante con tamaño de fuente destacado */}
      ...
      <div style={{ display: 'flex', alignItems: 'center', color: '#94a3b8', fontSize: '0.9rem', marginBottom: '1.5rem' }}>
        {/* Despliega la información del barrio donde se ubica el restaurante */}
        <MapPin size={14} style={{ marginRight: '4px' }} />
        {restaurant.barrio}
      </div>
      
      {/* Enlace que redirige a la página de detalles del restaurante seleccionado */}
